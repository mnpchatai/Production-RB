...
--
-- cascade ตรงนี้ไล่ได้แค่ในกลุ่มตารางที่มาจาก Excel เท่านั้น — ตารางบันทึกผลการผลิต
-- (rb_jobs และตาราง run ทั้งหมดใน ops_schema.sql) ตั้งใจไม่ผูก foreign key มาที่นี่
-- การนำเข้า Excel รอบใหม่จึงไม่แตะบันทึกผลที่หน้างานกรอกไว้
